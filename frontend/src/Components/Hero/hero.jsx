...
function Hero() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center mx-auto mt-10 md:px-16 md:ml-30">
      <div className="mb-14 md:ml-10 lg:mb-0 lg:w-1/2 md:w-1/2 mx-auto">
        ...
        <div className="flex space-x-4 mt-6 md:mt-14 justify-center  lg:justify-start">
